...
#Bookstack no longer under active development, superseded by [Digest](https://github.com/shiggsy365/digest)
...
- **Store** discovers books, checks local availability, and requests missing titles through Shelfmark, automatically adding new titles to the library.
