...
The fastest way to get Bookstack running alongside your existing services is via Docker.
...
4. Add the SMTP\_USER email address you configured above to the list of approved senders.
...
**Version Note:** This documentation is maintained for version 1.0 (Nov 2025).
