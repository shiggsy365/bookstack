...
GRIMMORY_URL = os.environ.get('GRIMMORY_URL', 'http://grimmory:6060/api/v1/opds')
GRIMMORY_USER = os.environ.get('GRIMMORY_USER', '')
GRIMMORY_PASS = os.environ.get('GRIMMORY_PASS', '')
...
if not GRIMMORY_USER or not GRIMMORY_PASS:
    raise RuntimeError('GRIMMORY_USER and GRIMMORY_PASS must be configured')
